...
void init_vertex(graphlab::async_consistent_engine<PreprocessProgram>::icontext_type& context,
...
int main(int argc, char** argv) {
    ...
    // Running The Engine -------------------------------------------------------
    graphlab::async_consistent_engine<PreprocessProgram> *engine = new
        graphlab::async_consistent_engine<PreprocessProgram>(dc, graph, clopts);
